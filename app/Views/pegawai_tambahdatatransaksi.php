...
<div style="padding-left:23px; padding-right:23px;">
  ...
  <input type="date" class="form-control" id="exampleFormControlInput1" name="tanggal" value="<?=date('Y-m-d')?>" required>
    </div>
...
<a href="<?= base_url('/pegawai/datatransaksi')?>"><button type="button" class="btn" style="margin-top:35px; margin-left:57px; border-radius:6px; padding-left:20px; padding-right:20px; background-color : #5d535e; color:white">KEMBALI</button></a>
