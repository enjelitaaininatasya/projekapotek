...
<div style="margin-bottom:20px; padding-left:23px; padding-right:23px;"> 
    <h3 style="color:white">Tambah Laporan Keuangan</h3>
...
<div style="padding-left:23px; padding-right:23px;">
  ...
  <input name="pemasukan" type="text" class="form-control" id="exampleFormControlInput1" required>
    </div>

    <div class="mb-1">
  <label for="exampleFormControlInput1" style="font-size:14px" class="form-label"><span style="color:white">Total</span></label>
  <input name="total" type="text" class="form-control" id="exampleFormControlInput1" required>
    </div>
...
<a href="<?= base_url('/admin/laporankeuangan')?>"><button type="button" class="btn" style="margin-top:35px; margin-left:57px; border-radius:6px; padding-left:20px; padding-right:20px; background-color : #5d535e; color:white">KEMBALI</button></a>
