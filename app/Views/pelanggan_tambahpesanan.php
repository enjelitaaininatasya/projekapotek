...
<div style="margin-bottom:20px; padding-left:23px; padding-right:23px;"> 
    <h3 style="color:white">Tambah Pesanan</h3>
...
<div style="padding-left:23px; padding-right:23px;">
    ...
    <div class="mb-1">
      <label for="exampleFormControlInput1" style="font-size:14px" class="form-label"><span style="color:white">Obat</span></label>
    ...
    <div class="mb-1">
      <label for="exampleFormControlInput1" style="font-size:14px" class="form-label"><span style="color:white">Jumlah</span></label>
