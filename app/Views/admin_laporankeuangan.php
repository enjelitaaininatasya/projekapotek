...
<center><h1 style="color:white">Laporan Keuangan</h1></center>
...
<thead>
    <tr>
      ...
      <th scope="col" style="background-color:#5d535e; color:white">Pemasukan</th>
      <th scope="col" style="background-color:#5d535e; color:white">Total</th>
...
foreach($laporann as $laporan){
  ?>
  <tr>
  <td style="background-color:#5d535e; color:white"><?=$laporan['id_laporan']?></td>
  <td style="background-color:#5d535e; color:white"><?=$laporan['tanggal']?></td>
  <td style="background-color:#5d535e; color:white"><?=$laporan['pemasukan']?></td>
  <td style="background-color:#5d535e; color:white"><?=$laporan['total']?></td>
  <td style="background-color:#5d535e; color:white"></td>
  <td style="background-color:#5d535e;">
        <a href="<?= base_url('/admin/editlaporan/' . $laporan['id_laporan']) ?>"><button class="btn" style="background-color : #dfe166; color:5d535e;">EDIT</button></a>
        <a href="<?= base_url('/admin/hapuslaporan/' . $laporan['id_laporan']) ?>"><button class="btn" style="background-color : #dfe166; color:5d535e;">HAPUS</button></a>
  </td>
</tr>
<?php
}
...
<a href="<?= base_url('/admin/tambahlaporankeuangan')?>"><button type="button" class="btn" style="margin-top:35px; margin-left:98px; border-radius:6px; padding-left:20px; padding-right:20px; background-color : #5d535e; color:white;">TAMBAH</button></a>
