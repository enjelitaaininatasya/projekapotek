...
<div style="padding-left:23px; padding-right:23px;">
    ...
    <form action="<?= base_url('/admin/updatedatatransaksi/' . $data['id_datatransaksi']) ?>" method="POST">
  ...
  <input type="text" class="form-control" id="exampleFormControlInput1" name="tanggal" value="<?=$data['tanggal']?>">
    </div>
