...
<a href="<?= base_url('/pegawai/tambahlaporankeuangan')?>"><button type="button" class="btn" style="margin-top:35px; margin-left:98px; border-radius:6px; padding-left:20px; padding-right:20px; background-color : #5d535e; color:white;">TAMBAH</button></a>
