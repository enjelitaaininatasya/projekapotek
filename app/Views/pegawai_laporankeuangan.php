...
<ul class="nav justify-content-center" style="margin-top:20px;">
  ...
  <li class="nav-item">
        <a href="<?=base_url('/pegawai/laporankeuangan')?>"><button type="button" class="btn" style="margin-right:25px; padding-left:40px; padding-right:40px; background-color : #C67C4E; color:black">Laporan Keuangan</button></a>
  </li>
  <li class="nav-item">
...
<a href="<?= base_url('/pegawai/tambahlaporankeuangan')?>"><button type="button" class="btn" style="margin-top:35px; margin-left:57px; border-radius:6px; padding-left:20px; padding-right:20px; background-color : #C67C4E; color:white">Tambah</button></a>
